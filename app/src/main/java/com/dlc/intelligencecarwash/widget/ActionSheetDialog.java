...
//        });
    ...
    public ActionSheetDialog setOnCancleClickListener(OnCancleClickListener listener){
        ...
        txt_cancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnCancleClickListener!=null){
                    mOnCancleClickListener.onClick(v);
                }
                dialog.dismiss();
            }
        });
    ...
    public enum SheetItemColor {
        Blue("#037BFF"), Red("#FD4A2E"),Gray("#adadad"),MainColor("#c500ff");
